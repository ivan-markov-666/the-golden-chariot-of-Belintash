...
describe('saveSlotsStore', () => {
  ...
  it('setSlot merges data and updates hasOccupied', () => {
    act(() => {
  ...
  it('deleteSlot clears entries and recalculates hasOccupied', () => {
    act(() => {
  ...
  it('reset accepts custom slots and clones data', () => {
    const custom = [
      {
        id: 'alpha',
        occupied: true,
